...
document.addEventListener("DOMContentLoaded", function () {
	...
	document.getElementById('search-input').addEventListener('input', function (e) {
		...
		var filteredData = fullTransactionData.filter(function (transaction) {
			var foundInName = transaction.name.toLowerCase(searchString) > -1;
			var foundInFor = transaction.for.toLowerCase(searchString) > -1;
			var foundInDate = transaction.date.toLowerCase(searchString) > -1;
			var foundInAmount = transaction.amount.toLowerCase(searchString) > -1;
